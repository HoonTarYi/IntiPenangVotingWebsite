...
<script type="text/javascript">
					$(document).ready(function(){
						...
						var fieldHTML = '<br><br><div><label class="col-xs-2 control-label" for="inputWarning" name="nameoptions">Options</label><input type="text" class="form-control" name="name" placeholder="name" value="<?php if (isset ($_POST['name[x]'])) {print htmlspecialchars($_POST['name[x]']); } ?>" /><br><input type="file" name="field_name" accept="image/*"><a href="javascript:void(0);" class="remove_button"><br><br><img width ="30" height="30" align="center" src="images/dlt.png"/></a></div>'; 
...
<form id="regForm" action="pollsoptdb.php" method="POST">
 ...
 <div class="field_wrapper">
                    ...
                    <label class="col-xs-2 control-label" for="inputWarning" name="nameoptions">Options</label>
